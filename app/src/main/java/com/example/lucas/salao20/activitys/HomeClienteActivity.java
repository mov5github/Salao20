...
public class HomeClienteActivity extends AppCompatActivity {
    ...
    //CONTROLES
    private static boolean homeClienteActivityAtiva;
    ...
    protected void onStart() {
        super.onStart();
        Log.i("script","HomeClienteActivity() onStart()");
        homeClienteActivityAtiva = true;
    ...
    protected void onStop() {
        super.onStop();
        Log.i("script","HomeClienteActivity() onStop()");
    ...
    protected void onDestroy() {
        super.onDestroy();
        Log.i("script","HomeClienteActivity() onDestroy()");
        homeClienteActivityAtiva = false;
    ...
    private void initView() {
        ...
        mToolbar.setTitle("HOME CLIENTE");
        mToolbar.setSubtitle("cliente");
        mToolbar.setLogo(R.mipmap.ic_launcher);
        setSupportActionBar(mToolbar);

        //TABS
        mViewPager = (ViewPager) findViewById(R.id.vp_tabs_tabs);
        String[] titles = {FragmentHomeClienteSaloes.getTITULO(), FragmentHomeClienteAgenda.getTITULO(), FragmentHomeClientePromocoes.getTITULO()};
        mViewPager.setAdapter(new HomeClienteAdapter(getSupportFragmentManager(),this,titles));
