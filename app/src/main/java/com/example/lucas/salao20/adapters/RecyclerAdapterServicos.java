...
public class RecyclerAdapterServicos extends RecyclerView.Adapter<RecyclerAdapterServicos.MyViewHolder>{
    private List<Servico> mList;
    private LayoutInflater mLayoutInflater;
    private RecyclerViewOnClickListenerHack mRecyclerViewOnClickListenerHack;

    public RecyclerAdapterServicos(List<Servico> mList, Context context) {
        this.mList = mList;
